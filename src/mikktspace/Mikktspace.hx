 ...
 * Copyright (c) 2020 Malody Hoe. Licensed under the MIT license.
 */
 package mikktspace;
 ...
 class SMikkTSpaceInterface
 {
     ...
     public var m_getPosition:(pContext:SMikkTSpaceContext, fvPosOut:Array<FastFloat>, iFace:Int, iVert:Int)->Void;
     public var m_getNormal:(pContext:SMikkTSpaceContext, fvNormOut:Array<FastFloat>, iFace:Int, iVert:Int)->Void;
     public var m_getTexCoord:(pContext:SMikkTSpaceContext, fvTexcOut:Array<FastFloat>, iFace:Int, iVert:Int)->Void;
     ...
     public var m_setTSpaceBasic:(pContext:SMikkTSpaceContext, fvTangent:Array<FastFloat>, fSign:FastFloat, iFace:Int, iVert:Int)->Void;
     ...
     // But averaging/overwriting tangent spaces by using an already existing index list WILL produce INCRORRECT results.
     // DO NOT! use an already existing index list.
     public var m_setTSpace:(pContext:SMikkTSpaceContext, fvTangent:Array<FastFloat>, fvBiTangent:Array<Float>, fMagS:Float, fMagT:Float,
 ...
 {
     public var m_pInterface:SMikkTSpaceInterface; // initialized with callback functions
     public var m_pUserData:Dynamic;               // pointer to client side mesh data etc. (passed as the first parameter with every interface call)
 }
 ...
 abstract SEdge(Array<Int>) to Array<Int> from Array<Int>
 {
 ...
 class Mikktspace
 {
     ...
     public static function genTangSpace(pContext:SMikkTSpaceContext, fAngularThreshold:FastFloat):Bool
     {
         ...
         for (f in 0...iNrFaces)
         {
             ...
             for (i in 0...verts)
             {
                 ...
                 var tang = [pTSpace.vOs.x, pTSpace.vOs.y, pTSpace.vOs.z];
                 var bitang = [pTSpace.vOt.x, pTSpace.vOt.y, pTSpace.vOt.z];
                 if (pContext.m_pInterface.m_setTSpace!=null)
                     pContext.m_pInterface.m_setTSpace(pContext, tang, bitang, pTSpace.fMagS, pTSpace.fMagT, pTSpace.bOrient, f, i);
                 if (pContext.m_pInterface.m_setTSpaceBasic!=null)
                     pContext.m_pInterface.m_setTSpaceBasic(pContext, tang, pTSpace.bOrient ? 1.0 : (-1.0), f, i);
     ...
     {
         var res:SVec3 = {}; var pos:Array<FastFloat> = [0,0,0];
     ...
     {
         var res:SVec3 = {}; var norm:Array<FastFloat> = [0,0,0];
         var data = IndexToData(index);
         var iF = data.iFace, iI = data.iVert;
     ...
     {
         var res:SVec3 = {}; var texc:Array<FastFloat> = [0,0];
         var data = IndexToData(index);
         var iF = data.iFace, iI = data.iVert;
         pContext.m_pInterface.m_getTexCoord(pContext, texc, iF, iI);
         res.x=texc[0]; res.y=texc[1]; res.z=1.0;
         return res;
     }
